...
export default function Form() {
  ...
  const handleSubmitForm = async (e) => {
    ...
    if (state.contentForms.length === state.inputs.length) {
      ...
      alert("The data you have entered has not been successfully recorded");
    }
  };
  ...
  //     } else {
  //       alert("uncessfull edit");
  //     }
  //   } else {
  //     alert("The Title Form cannot be Empty");
  //   }
  // };
  ...
  return !isAdmin() ? (
    ...
    <section>
      <form
        onSubmit={(e) =>
          state.isEdit ? '' : handleSubmitForm(e)
        }
